/**
 *Submitted for verification at polygonscan.com on 2024-01-21
*/
...
contract TerryCoin is ERC20, ERC20Permit {
    constructor() ERC20("Terry Coin", "TERRY") ERC20Permit("Terry Coin") {
        _mint(msg.sender, 93700000000000 * 10 ** decimals());
    }
}